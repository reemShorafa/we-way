...
export const images = {
  ...
  north: 'https://images.unsplash.com/photo-1500534623283-312aade485b7?auto=format&fit=crop&w=800&q=80',
...
export const copy = {
  ar: {
    nav: ['الرئيسية', 'المميزات', 'كيف نعمل', 'رحلاتنا', 'آراء العملاء'],
    dl: 'حمل التطبيق',
    ...
    mem: 'لحظاتٌ موثّقة.. وذكريات تدوم للأبد',
    ...
    view: 'عرض التفاصيل',
    footer: 'WeWay يجمع الأصدقاء في وجهة واحدة وينظم الرحلة من أول خطوة حتى آخر ذكرى.'
  },
  en: {
    ...
    tesub: 'Real experiences from friends who made their trips easier and more organized with WeWay.',
    cta: 'Ready for your next adventure?',
    ctas: 'Bring your friends together, plan your trip, and let WeWay handle the details.',
    view: 'Explore trip',
    footer: 'WeWay brings friends together in one destination and organizes the journey from the first step to the final memory.'
  }
};
...
export const features = [
  {
    ...
    arText: 'كن على اتصال دائم مع أصدقائك وتعرف على مواقعهم لحظة بلحظة مع رسم مسار مباشر للوصول إليهم بكل سهولة.',
    enTitle: 'Live Map Tracking'
  },
  {
    Icon: Brain,
    arTitle: 'خطط الرحلات الذكية والمقترحة',
    arText: 'حدد وجهتك ودع التطبيق يقترح عليك جدول زيارات متكامل لأبرز الأماكن، مع عرض مواقعها على الخريطة وتفاصيلها الشاملة.',
    enTitle: 'Smart Trip Plans'
  },
  {
    Icon: MessageCircle,
    arTitle: 'دردشة جماعية خاصة بالرحلة',
    arText: 'مساحة تواصل فورية تجمع أفراد الرحلة لتنسيق الخطوات، تبادل التحديثات، ومشاركة اللحظات أولاً بأول.',
    enTitle: 'Trip Group Chat'
  },
  {
    Icon: ShieldCheck,
    arTitle: 'المحفظة الجماعية وإدارة الصلاحيات',
    arText: 'نظام مالي منظم يتيح تعيين مسؤول للمحفظة للتحكم بالميزانية ومتابعة الأمور المالية بسلاسة.',
    enTitle: 'Shared Wallet'
  },
  {
    Icon: Wallet,
    arTitle: 'إدارة المصاريف وتسوية الحسابات',
    arText: 'تسجيل دقيق لجميع المصروفات بعملة الوجهة، مع حساب آلي يوضح حصة كل فرد وما دفعه بدقة تامة.',
    enTitle: 'Expense Management'
  },
  {
    Icon: FileText,
    arTitle: 'تقرير شامل للرحلة',
    arText: 'توثيق متكامل لكافة تفاصيل المحطة والرحلة في تقرير نهائي يجمع إحصائيات وأحداث مغامرتكم.',
    enTitle: 'Trip Report'
  },
  {
    Icon: Camera,
    arTitle: 'سجل الذكريات',
    arText: 'مساحة مخصصة لرفع وحفظ صور ومقاطع فيديو الرحلة لتخليد أجمل اللحظات في سجل ذكريات مشترك.',
    enTitle: 'Shared Memories'
  },
  {
    Icon: Compass,
    arTitle: 'استكشاف الأماكن على طول المسار',
    arText: 'اقتراح ذكي لأبرز المعالم الأثرية، السياحية، التعليمية، والرياضية القريبة من مسارك على الخريطة مع توجيه مباشر للوصول إليها.',
...
export const steps = [
  {
    ...
    arText: 'امنح مغامرتك اسماً وصورة تعكس روح الشلة، حدد بدقة مكان التجمع ونقطة اللقاء، وجهّز قائمة مستلزماتك لتنطلقوا بكل جاهزية وترتيب.',
    enTitle: 'Name your trip and get ready'
  },
  {
    Icon: Compass,
    arTitle: 'حدد وجهتك وجدولك الزمني',
    arText: 'حدد مكان وجهتكم بدقة، وادخل تاريخ بدء الوصول وتاريخ المغادرة لتنظيم وقت الرحلة بكل دقة.',
    enTitle: 'Set your destination and schedule'
  },
  {
    Icon: Users,
    arTitle: 'اجمع أصدقائك وشاركهم المغامرة',
    arText: 'أرسل دعواتك للأصدقاء بنقرة واحدة، واجمع فريق الرحلة في مكان واحد لتكونوا على استعداد تام للانطلاق معاً.',
    enTitle: 'Invite friends into the adventure'
  },
  {
    Icon: Wallet,
    arTitle: 'أضف مصروفات ما قبل الانطلاق',
    arText: 'سجل التكاليف والمشتريات الأولية بعملة وجهتكم بدقة قبل بدء الرحلة لتبدأوا حساباتكم بشكل منظم وواضح.',
    enTitle: 'Add pre-trip expenses'
  },
  {
    Icon: Brain,
    arTitle: 'جدول ذكي بالذكاء الاصطناعي لوجهتكم',
    arText: 'دع الذكاء الاصطناعي يصمم لك خطة زيارات متكاملة ومخصصة خصيصاً لأفضل الأماكن والأنشطة داخل وجهتكم بكل سهولة.',
    enTitle: 'An AI-made itinerary'
  }
];

export const trips = [
  ['مغامرة الشمال', 'Northern Adventure', 'عسير، السعودية', 'Asir, Saudi Arabia', images.north],
  ['هروب إسطنبول', 'Istanbul Escape', 'إسطنبول، تركيا', 'Istanbul, Turkey', images.istanbul],
  ['رحلة البحر الأحمر', 'Red Sea Journey', 'جدة، السعودية', 'Jeddah, Saudi Arabia', images.sea],
  ['ويكند في دبي', 'Dubai Weekend', 'دبي، الإمارات', 'Dubai, UAE', images.dubai]
];

export const reviews = {
  ar: [
    ['نورة خالد', 'رحلتنا إلى إسطنبول صارت أوضح وأسهل. كل شيء كان في مكان واحد.', 'إسطنبول'],
    ['عبدالله صالح', 'المحفظة الجماعية ممتازة، انتهت حسابات آخر الرحلة المحرجة.', 'العلا'],
    ['لينا عمر', 'الخريطة جعلتنا قريبين من بعض طوال الرحلة.', 'جدة']
  ],
  en: [
    ['Nora Khalid', 'Our Istanbul trip became clearer and lighter. Everything in one place.', 'Istanbul'],
    ['Abdullah Saleh', 'The shared wallet is brilliant. No more awkward math.', 'AlUla'],
    ['Lina Omar', 'The map made us feel close to one another all trip long.', 'Jeddah']
  ]
};
